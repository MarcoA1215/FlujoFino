...
files.forEach(f => {
  ...
  // Replace direct words first to be safe
  ...
  content = content.split('').join('í'); // Be careful, replacement character could be anything, let's just do targeted
