...
let ctrlCode = fs.readFileSync('apps/backend/src/products/products.controller.ts', 'utf8');
const endOfCtrl = ctrlCode.lastIndexOf('}');
const newCtrlMethod = `
  @Get('migrate-stock')
...
`;
ctrlCode = ctrlCode.substring(0, endOfCtrl) + newCtrlMethod + '\n}';
fs.writeFileSync('apps/backend/src/products/products.controller.ts', ctrlCode, 'utf8');
